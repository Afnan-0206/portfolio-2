...
import { Mail, Phone, MapPin, Clock3, FileText, Sparkles } from "lucide-react";
        ...
        >
          ...
          >
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              ...
              >
                <GithubIcon className="h-4 w-4 text-slate-100" />
                GitHub
              </a>
              <a
              ...
              >
                <LinkedinIcon className="h-4 w-4 text-slate-100" />
                LinkedIn
              </a>
              <a
                href="/resume.pdf"
